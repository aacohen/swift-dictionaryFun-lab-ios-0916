...
class IcecreamTests: XCTestCase {
    ...
    func testReplaceFlavorForJoe() {
        let flavorIsChanged = testIcecream.replace(newflavor: "Berry", forPerson: "Joe")
    ...
    func testReplaceFlavorForNonExistentPerson() {
        let flavorIsChanged = testIcecream.replace(newflavor: "Strawberry", forPerson: "Jon Snow")
